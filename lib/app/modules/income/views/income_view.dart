...
class IncomeView extends GetView<IncomeController> {
  ...
  IncomeController incomeC = Get.put(IncomeController());
  ...
  //         stream: incomeC.streamDataIncome(),
  ...
  //                 var docInc = snapshot.data!.docs[index];
  //                 Map<String, dynamic> income = docInc.data();
  //                 menuOption(String value) async {
  //                   if (value == 'update') {
  //                     Get.toNamed(Routes.UPDATE, arguments: docInc.id);
  //                   } else if (value == 'delete') {
  //                     bool? yes = await DInfo.dialogConfirmation(
  //                         context, 'Hapus', 'Yakin unutuk menghapus?');
  //                     if (yes ?? false) {
  //                       incomeC.deleteHistory(docInc.id);
  //                       Get.back();
  //                     }
  //                   }
  //                 }
  ...
  //                     onTap: () {
  //                       Get.toNamed(Routes.DETAIL, arguments: docInc.id);
  //                     },
  //                     child: Row(
  //                       children: [
  //                         const SizedBox(
  ...
  //                         Expanded(
  //                             child: Text(
  //                           AppFormat.currency(income['total'].toString()),
  //                           style: const TextStyle(
  //                               color: Colors.white,
  //                               fontWeight: FontWeight.bold,
  //                               fontSize: 16),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        incomeC.performSearch(Csearch.text);
                      },
                      icon: const Icon(Icons.search),
                      color: Colors.white,
                    ),
      ...
      body: Obx(() {
        var future = incomeC.searchFuture.value;
        return future == null
